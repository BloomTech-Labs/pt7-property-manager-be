    ...
    .then(function() {
      ...
      return knex("users").insert([
        ...
        },
        {
          ...
          role: "Manager",
          img:
            "https://vignette.wikia.nocookie.net/mazinger/images/2/26/Koji_Kabuto.png/revision/latest?cb=20190812081130"
        },
        {
          email: "Manger10@gmail.com",
          password: bcrypt.hashSync("password", 16),
          phoneNumber: "1234567890",
        ...
        {
          email: "carlo.s16@hotmail.com",
          password: bcrypt.hashSync("password", 16),
          phoneNumber: "2396015295",
          firstName: "Carlos",
          lastName: "Sanchez",
          role: "Manager",
          img: null
        ...
        {
          email: "caleb@redd.com",
          password: bcrypt.hashSync("password", 16),
          phoneNumber: "9283028624",
          firstName: "Caleb",
          lastName: "Redd",
          role: "Manager",
          img: null
        ...
        },
        {
          ...
          password: bcrypt.hashSync("password", 16),
          phoneNumber: "9547024279",
          firstName: "Carlos",
          lastName: "Mitchell",
          role: "Renter",
          img:
            "https://insights.ehotelier.com/wp-content/uploads/sites/6/2018/08/Average-Joe.jpg"
        },
        {
          email: "fake10@gmail.com",
          password: bcrypt.hashSync("password", 16),
          phoneNumber: "1800411PAINS",
          firstName: "Carlos",
          lastName: "Mitchell",
          role: "Renter",
          img:
